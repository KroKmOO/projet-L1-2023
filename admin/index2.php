...
if (isset($_POST['valider'])) {
  if (isset($_POST['image1']) and isset($_POST['nom']) and isset($_POST['prix']) and isset($_POST['desc'])) {
    if (!empty($_POST['image1']) and !empty($_POST['nom']) and !empty($_POST['prix']) and !empty($_POST['desc'])) {
      ...
      try {
        ajouter($image1, $image2, $image3, $image4, $nom, $prix, $desc, $appv, $type, $obtenteur, $couleur, $Dispo);
              ...
              <form method="post">
                <li class="completed">
                  <div class="mb-3">
                    ...
                    <input type="name" class="form-control" name="image1" required>
                  </div>
                ...
                <li class="completed">
                  <div class="mb-3">
                    ...
                    <input type="name" class="form-control" name="image4" required>
                  </div>
                  <i class='bx bx-dots-vertical-rounded'></i>
                </li>
                <li class="completed">
                ...
                <li class="completed">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="appv" required>
                  </div>
                  <i class='bx bx-dots-vertical-rounded'></i>
                </li>
                <li class="completed">
                ...
                <li class="completed">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="obtenteur" required>
                  </div>
                  <i class='bx bx-dots-vertical-rounded'></i>
                </li>
                <li class="completed">
                ...
                <li class="completed">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Dispo" required>
                  </div>
                  <i class='bx bx-dots-vertical-rounded'></i>
                </li>
                <li class="completed">
                ...
                <button type="submit" name="valider" class="btn">Ajouter un nouveau produit</button>
              </form>
            </ul>
          </div>
        </div>
